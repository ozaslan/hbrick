...
TEST(BrickSearchBaseline, MatchesBfsOnEightByEightRandomMaze) {
    ...
    hbrick::test_support::expectBrickSearchMatchesBfs(
        layout,
        graph.csrGraph(),
        hbrick::TileSize{4U, 4U},
        "BrickSearchEightByEight"
    );
}

TEST(BrickSearchBaseline, MatchesBfsOnSixteenBySixteenBidirectionalMaze) {
...
TEST(BrickSearchBaseline, SameTileReentryWhenLocalClosureIsZero) {
